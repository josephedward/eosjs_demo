import React, { useState, useEffect, useRef, 
  ...
  import SearchABI from "../components/SearchABI.spec";
  import currentInfo from "./mock/get_info.js"
  import currentBlock from "./mock/get_block.js"
//   import currentAbi from "./mock/get_abi.js"
  ...
  async function grabTen(latestBlockNum) {
    ...
    try {
      for (let x = 10; x > 0; x--) {
        ...
        // currentBlock.staticFlag=true;
        let tempBlock = currentBlock
        // await rpc.get_block(blockIndex);
  ...
  function BlockListTest() {
    ...
    useInterval(async () => {
      try {
        ...
        // currentBlock.staticFlag=false;
        let currentBlockCopy = {...currentBlock};
         currentBlockCopy.staticFlag=false;
        // currentBlockCopy.transactions=[]
        recentBlocks.push(currentBlockCopy);
